...
class _SignUpFormState extends State<SignUpForm> with SingleTickerProviderStateMixin {
  // Step 3: Add animation controller
      ...
      children: [
        ...
        Container(
          ...
          child: FlatButton(
            ...
            // Step 1: add callback here and navigate to welcome screen when button is tapped
...
class _SignUpFormBodyState extends State<SignUpFormBody> {
  ...
  List<TextEditingController> get controllers => [emailController, phoneController, websiteController];
